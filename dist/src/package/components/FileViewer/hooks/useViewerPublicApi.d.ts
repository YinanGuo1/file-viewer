...
import { FileViewerPublicApi as FileViewerExpose, FileViewerOperationAvailability } from '@file-viewer/core';
 ...
 */
export declare const useViewerPublicApi: ({ operationAvailability, ...api }: UseViewerPublicApiOptions) => FileViewerExpose;
export {};
