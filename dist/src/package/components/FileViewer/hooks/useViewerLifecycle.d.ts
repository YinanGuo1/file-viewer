import { FileViewerErrorMessageFormatter, FileViewerFileRef, FileViewerLifecycleComponentEmit, FileViewerLifecycleContext, FileViewerOperationContext, FileViewerOptions } from '@file-viewer/core';
 ...
 * 当前状态组合起来，保持入口组件更薄。
 */
export declare const useViewerLifecycle: ({ getOptions, getFilename, getBufferSize, getCurrentFile, getCurrentVersion, getFallbackFile, getFallbackUrl, emitLifecycle, emitOperationBefore, emitOperationCancel, formatErrorMessage, handleLifecycleError, handleOperationError, onOperationErrorMessage }: UseViewerLifecycleOptions) => import('@file-viewer/core').FileViewerLifecycleFacade;
export {};
